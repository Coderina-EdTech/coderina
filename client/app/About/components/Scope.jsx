...
const Scope = () => {
  ...
  return (
    <div className="w-full  px-2 md:px-4 lg:px-8 py-10 ">
      ...
      <div className="w-full grid md:grid-cols-4 items-start md:items-center justify-between space-y-[7rem] md:space-y-0 md:gap-x-5">
          ...
          return (
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="font-semibold text-[14px]">{scopeCard.text}</h3>
