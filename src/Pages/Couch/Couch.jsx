...
const Couch = () => {
    ...
    const couchInfos = [
        {
            title: 'About',
            content: ['Coderina® University Challenge (COUCH) is an event aimed at promoting innovation among students in Tertiary education in Nigeria. A 48 hours Challenge where teams of students with diverse background and skill set come together to solve “indigenous” problems using technology or modern business approaches. The aim is to foster collaboration, network, learn and build stuff that would change the world.', 'Objectives'],
            type: "p",
