import { Box, Container, FormControl, FormControlLabel, FormLabel, Radio, RadioGroup, Stack, Typography } from '@mui/material'
import React from 'react'
import { Select } from '@chakra-ui/react'
import Grid from '@mui/material/Grid2';
import { Input } from 'antd';
import CustomButton from '../../Pages/Home/components/CustomButton'
                ...
                <Stack className='register__form'>
                    <Grid container>
                        <Grid size={{ xs: 12, md: 5 }}>
                            <Typography variant='h4'>Register for the Coderina® University Challenge (COUCH)</Typography>
                            ...
                            <form action="">
                                {formInfo1.map((info, i) => (
                                    <Stack key={i}>
                                        ...
                                        <Input type={info.type} placeholder={info.placeholder} required={info.required} />
                                    </Stack>
                                ))}
                                ...
                                {formDrop.map((info, i) => (
                                    <Stack key={i} className='form__drop'>
                                        <Typography>{info.title}</Typography>
                                        <Select icon={"none"} placeholder={info.placeholder} required={info.required} />
                                    </Stack>
                                ))}
                                <Stack>
                                    <Typography>Idea Name</Typography>
                                    <Input type="text" placeholder="What’s your idea?" required={true} />
                                </Stack>
                                <Stack>
